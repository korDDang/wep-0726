...
try{
	String sql="select m.M_NO,p.P_NAME,m.M_NAME,count(v.M_NO) from member0726 m,vote0726 v,party0726 p where m.M_NO=v.M_NO and p.P_CODE=m.P_CODE group by m.M_NO,p.P_NAME,m.M_NAME order by count(v.M_NO) desc";
