...
<legend>선택</legend>
투표소 : <input type="radio" name="area" value="제1투표장" onclick="ch1()">제1투표장
	  <input type="radio" name="area" value="제2투표장" checked  onclick="ch2()">제2투표장
</fieldset>
<h2>'투표검수조회'</h2>
<%
...
<td class="td2">
<a href="update_vote.jsp?V_JUMIN=<%=V_JUMIN%>">수정</a> /
